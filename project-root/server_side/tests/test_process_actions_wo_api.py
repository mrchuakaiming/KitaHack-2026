...
# =========================================================
# 1. Patch config modules (prevent ValueError on import)
# =========================================================
...
@patch("server_side.src.logic.process_actions.generate_prompt_for_user", return_value="Nice choice!")
...
def test_our_model_success(mock_gemini, mock_ai_prompt, mock_user_prompt):
    ...
    assert result["justification"] == "Nice choice!"
